...
from apsimNGpy.utils.utils import collect_runfiles
...
if __name__ == "__main__":
    ...
    run_apsimx_files_in_parallel(files, num_cores=10, use_threads=False)
    ...
    dat = read_result_in_parallel(files_db, num_cores=10)
